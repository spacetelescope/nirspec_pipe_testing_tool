...
keywd_dict['SRCTYAPT'] = ['UNKNOWN', 'POINT', 'EXTENDED']  # source type as defined by user in APT
...
keywd_dict['FXD_SLIT'] = ['NONE', 'S200A1', 'S200A2', 'S200B1', 'S400A1', 'S1600A1',
                          'NULL']  # name of fixed slit aperture used
...
# keywords added for build 7.1 from
# https://confluence.stsci.edu/display/JWSTPWG/Build+7.1+Updates+for+Testing+and+Reports
