...
```bash
pip install git+https://github.com/spacetelescope/nirspec_pipe_testing_tool@2.0.0
```
where the numbers at the end represent the latest stable version of NPTT (flight version during 
commissioning is 2.0.0); for the most recent code, in the 
terminal type:
```bash
